...
class PlanController extends ExtendedController
{
    ...
    #[Route('/applications', name: 'club_plan_applications')]
    #[Breadcrumb([
        ['label' => 'home', 'route' => 'club_dashboard'],
        ['label' => 'plans', 'route' => 'club_plans'],
        ['label' => 'applications'],
    ...
    public function applications(Request $request): Response
    {
        ...
        return $this->render('club/plan/applications.html.twig', [
            'club' => $club,
            'applications' => $applications,
    ...
    #[Route('/applications/{id}/cancel', name: 'club_plan_application_cancel', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[IsGranted('MANAGE')]
    public function cancelApplication(PlanApplication $application, Request $request): Response
    {
