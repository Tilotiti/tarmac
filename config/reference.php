 ...
 * }
 * @psalm-type TilowebPaginationConfig = array{
 *     template?: scalar|Param|null, // Default: "@TilowebPagination/pagination.html.twig"
 * }
 * @psalm-type SlopeItBreadcrumbConfig = array{
 *     template?: scalar|Param|null, // Default: "@SlopeItBreadcrumb/breadcrumb.html.twig"
 * }
 * @psalm-type TranslationConfig = array{
 *     configs?: array<string, array{ // Default: {"default":{"dirs":[],"excluded_dirs":[],"excluded_names":[],"external_translations_dirs":[],"output_format":"xlf","blacklist_domains":[],"whitelist_domains":[],"remote_storage":[],"local_storage":["php_translation.local_file_storage.abstract"],"output_dir":"%kernel.project_dir%/Resources/translations","xliff_version":"2.0","new_message_format":"icu","local_file_storage_options":[]}}
 ...
 *         output_format?: scalar|Param|null, // Default: "xlf"
 *         blacklist_domains?: list<scalar|Param|null>,
 *         whitelist_domains?: list<scalar|Param|null>,
 *         remote_storage?: list<scalar|Param|null>,
 *         local_storage?: list<scalar|Param|null>,
 *         output_dir?: scalar|Param|null, // Default: "%kernel.project_dir%/Resources/translations"
 *         project_root?: scalar|Param|null, // The root dir of your project. By default this will be kernel_root's parent.
 *         xliff_version?: scalar|Param|null, // The version of XLIFF XML you want to use (if dumping to this format). // Default: "2.0"
 *         new_message_format?: scalar|Param|null, // Use "icu" to place new translations in "{domain}+intl-icu.{locale}.{ext}" container // Default: "icu"
 *         local_file_storage_options?: mixed, // Options passed to the local file storage's dumper. // Default: []
 *     }>,
 *     fallback_translation?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         service?: "google"|"yandex"|"bing"|Param, // Default: "google"
 *         api_key?: scalar|Param|null, // Default: null
 *     },
 *     edit_in_place?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         config_name?: scalar|Param|null, // Default: "default"
 *         activator?: scalar|Param|null, // Default: "Translation\\Bundle\\EditInPlace\\Activator"
 *         show_untranslatable?: scalar|Param|null, // Default: true
 *     },
 *     webui?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         allow_create?: bool|Param, // Default: true
 *         allow_delete?: bool|Param, // Default: true
 *         file_base_path?: scalar|Param|null, // Base path for SourceLocation's. Defaults to "%kernel.project_dir%". // Default: null
 *     },
 *     locales?: list<scalar|Param|null>,
 *     default_locale?: scalar|Param|null, // Your default language or fallback locale. Default will be kernel.default_locale
 *     symfony_profiler?: bool|array{ // Extend the debug profiler with information about requests.
 *         enabled?: bool|Param, // Turn the symfony profiler integration on or off. Defaults to kernel debug mode. // Default: true
 *         formatter?: scalar|Param|null, // Default: null
 *         captured_body_length?: int|Param, // Limit long HTTP message bodies to x characters. If set to 0 we do not read the message body. Only available with the default formatter (FullHttpMessageFormatter). // Default: 0
 *         allow_edit?: bool|Param, // Default: true
 *     },
 *     auto_add_missing_translations?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         config_name?: scalar|Param|null, // Default: "default"
 *     },
 *     http_client?: scalar|Param|null, // Default: "httplug.client"
 *     message_factory?: scalar|Param|null, // Default: "httplug.message_factory"
 * }
 ...
 *     }>,
 * }
 * @psalm-type UploadedFileTypeConfig = array{
 *     configurations?: array<string, array{ // Default: []
 *         filesystem?: scalar|Param|null, // Default: "@oneup_flysystem.default_adapter_adapter"
 *         base_uri?: scalar|Param|null, // Default: null
 *         path?: scalar|Param|null, // Default: null
 *         ...<mixed>
 *     }>,
 * }
 ...
 *     tiloweb_pagination?: TilowebPaginationConfig,
 *     slope_it_breadcrumb?: SlopeItBreadcrumbConfig,
 *     nucleos_dompdf?: NucleosDompdfConfig,
 *     oneup_flysystem?: OneupFlysystemConfig,
 *     uploaded_file_type?: UploadedFileTypeConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
